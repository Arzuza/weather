...
//getLatLong
  Future<Position> getGeoLocationPosition() async {
    ...
    //location service not enable, dont continue
    if (!serviceEnabled) {
    ...
    //permission dnied forever
    if (permission == LocationPermission.deniedForever) {
      return Future.error(
          'Location Permission Denied Forever, we cannot Access,');
    }

    //contionue accessing the positon of device
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                ...
                builder: (context, data) {
                  return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        var items = listDataForecast[index]['weather'][0]
                            ['description'];
                        ...
                        return Card(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                Text(
                                  SetTime.setTime(listDataForecast[index]
                                          ['dt_txt']
                                      .toString()),
                                  style: const TextStyle(
                                ...
                                Text(
                                    '${num.parse(listDataForecast[index]['main']['temp'].toString()).toStringAsFixed(0)} °C',
                                    style: const TextStyle(
                                        color: Colors.white, fontSize: 14)),
                                const SizedBox(
                                  height: 10,
                                  ...
                                  children: [
                                    Column(
                                      children: [
                                        ...
                                        Text(
                                            '${num.parse(listDataForecast[index]['main']['temp_min'].toString()).toStringAsFixed(0)}°C',
                                            style: const TextStyle(
                                                color: Colors.white,
                                                fontSize: 14)),
                                      ],
                                    ...
                                    Column(
                                      children: [
                                        ...
                                        Text(
                                            '${num.parse(listDataForecast[index]['main']['temp_max'].toString()).toStringAsFixed(0)}°C',
                                            style: const TextStyle(
                                                color: Colors.white,
                                                fontSize: 14)),
                                      ],
      ...
      //                       itemBuilder: (context, index) {
      //                         var items = listDataForecastDaily[index]
      ...
      //                         int strLongDate =
      //                             listDataForecastDaily[index]['dt'];
      ...
      //                                           ),
      //                                           Text(
      //                                               '${num.parse(listDataForecastDaily[index]['temp']['min'].toString()).toStringAsFixed(0)}°C',
      //                                               style: const TextStyle(
      //                                                   color: Colors.black,
      //                                                   fontSize: 14)),
      //                                         ],
      ...
      //                                           ),
      //                                           Text(
      //                                               '${num.parse(listDataForecastDaily[index]['temp']['max'].toString()).toStringAsFixed(0)}°C',
      //                                               style: const TextStyle(
      //                                                   color: Colors.black,
      //                                                   fontSize: 14)),
      //                                         ],
